...
class PostExitTracker:
    ...
    def format_telegram_card(self) -> str:
        ...
        lines.append('━━━━━━━━━━━━━━━━━━━')
        lines.append(
            "📖 <b>[매도 오답노트 초보자 3초 이해 가이드]</b>\n"
            "• 🟢 <b>[손실 회피]</b>: 내가 판 뒤에 주가가 더 떨어져서 <b>손실을 철저하게 방어</b>해 냄!\n"
            "• 🔴 <b>[조기 매도]</b>: 내가 판 뒤에 주가가 더 올라서, <b>다음 매매 시 익절 폭을 더 넓혀 길게 먹도록 스스로 파라미터 보정</b>\n"
            "• ⚪ <b>[적정 회전]</b>: 욕심부리지 않고 정상적으로 수익을 챙긴 뒤 다음 종목으로 깔끔하게 회전\n"
            "• <b>왜 중요한가요?</b>: 실패한 매매와 성공한 매매를 통계적으로 학습하여 다음 매매의 승률과 수익률을 자동으로 끌어올립니다."
        )
        return '\n'.join(lines)
