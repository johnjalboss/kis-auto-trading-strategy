...
CHANGED_FILES = [
    'strategy.py',       # QUANT: Check config.ECON_EVENT_GUARD_ENABLED before blocking on econ events
    'config.py',         # CONFIG: Set ECON_EVENT_GUARD_ENABLED = False to disable blanket daily economic event blocks
]
...
print("=" * 60)
print("DEPLOYING ECON CALENDAR BYPASS TO ORACLE VM...")
print("=" * 60)
...
print("\n" + "=" * 60)
print("ECON BYPASS DEPLOYED & LIVE!")
print("=" * 60)
