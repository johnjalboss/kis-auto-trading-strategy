...
FILES = [
    "screener.py", "composite_signal.py", "orchestrator.py",
    "finnhub_client.py", "news_analyzer.py", "insider_tracker.py",
    "earnings_analyzer.py", "test_finnhub.py", "dashboard_app.py",
    "base_adapters.py", "config.py", "data_proxy.py",
    "signal_aggregator.py", "decoded_composite_signal.py", "local_composite_signal.py",
    "macro.py", "sector_fund_flow.py"
]
