...
BLACKLIST_PATTERNS = [
    ...
    'CandlePattern', 'CandlestickSignal',
...
def _discover_adapters() -> List:
    ...
    for filename in py_files:
        ...
        for class_name, cls in inspect.getmembers(module, inspect.isclass):
            ...
            # Suffix check: Skip managers, traders, trackers (higher risk of side-effects)
            if any(s in class_name.lower() for s in ['manager', 'trader', 'tracker', 'auditor', 'journal']):
                continue
