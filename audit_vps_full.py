"""
Live VPS Full Directive Audit
Executes on Linux VPS to verify 100% compliance of all settings, databases, and core 39 modules.
"""
...
print("==========================================================")
print("[AUDIT] LIVE VPS FULL DIRECTIVE & MODULE AUDIT")
print("==========================================================")
...
# 8. Notifier Clean HTML Check
try:
    notifier_code = open("notifier.py", encoding="utf-8").read()
    # Check trade_entry function block specifically
    entry_block = notifier_code.split("def trade_entry")[1].split("def ")[0]
    has_raw_bug = ".replace('<', '&lt;')" in entry_block
    log_result("8. Notifier Clean HTML (No Raw Tags)", not has_raw_bug, "Clean HTML tags verified in trade_entry")
except Exception as e:
...
print(f"Final VPS Summary: {passed_count}/{len(results)} AUDIT CHECKS PASSED PERFECTLY!")
print("==========================================================")
